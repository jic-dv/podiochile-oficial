...
const data: Servicio[] = [
  // ─── Landing Page ──────────────────────────────────────────────────────
  {
    ...
    comparativa: [
      ...
      },
      {
        ...
        basico: { es: "Entrega en 7 días", en: "Delivery in 7 days" },
        estandar: { es: "Entrega en 12 días", en: "Delivery in 12 days" },
        premium: { es: "Entrega en 20 días", en: "Delivery in 20 days" },
      },
    ],
    faq: [
      {
    ...
    planes: [
      {
        ...
        entregaDias: 7,
        entrega: { es: "Entrega en 7 días", en: "Delivery in 7 days" },
        revisiones: 2,
        soporteMeses: 1,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: false,
        entregaDias: 12,
        entrega: { es: "12 días hábiles", en: "12 business days" },
        revisiones: 3,
        soporteMeses: 3,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: false,
        entregaDias: 20,
        entrega: { es: "20 días hábiles", en: "20 business days" },
        revisiones: 5,
        soporteMeses: 6,
        resumen: {
  ...
  // ─── Página Web Multipágina ────────────────────────────────────────────
  {
    ...
    comparativa: [
      ...
      {
        label: { es: "Plazo de entrega", en: "Delivery time" },
        basico: { es: "15 días hábiles", en: "15 business days" },
        estandar: { es: "25 días hábiles", en: "25 business days" },
        premium: { es: "40 días hábiles", en: "40 business days" },
      },
    ],
    faq: [
      {
    ...
    planes: [
      {
        ...
        precioEstimado: false,
        entregaDias: 15,
        entrega: { es: "15 días hábiles", en: "15 business days" },
        revisiones: 3,
        soporteMeses: 1,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: false,
        entregaDias: 25,
        entrega: { es: "25 días hábiles", en: "25 business days" },
        revisiones: 4,
        soporteMeses: 3,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: false,
        entregaDias: 40,
        entrega: { es: "40 días hábiles", en: "40 business days" },
        revisiones: 6,
        soporteMeses: 6,
        resumen: {
  ...
  // ─── CRM ───────────────────────────────────────────────────────────────
  {
    ...
    comparativa: [
      ...
      {
        label: { es: "Plazo estimado", en: "Estimated timeline" },
        basico: { es: "6 a 8 semanas", en: "6 to 8 weeks" },
        estandar: { es: "10 a 14 semanas", en: "10 to 14 weeks" },
        premium: { es: "16 a 24 semanas", en: "16 to 24 weeks" },
      },
    ],
    faq: [
      {
    ...
    planes: [
      {
        ...
        precioEstimado: true,
        entregaDias: 40,
        entrega: { es: "6 a 8 semanas", en: "6 to 8 weeks" },
        revisiones: 4,
        soporteMeses: 1,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: true,
        entregaDias: 70,
        entrega: { es: "10 a 14 semanas", en: "10 to 14 weeks" },
        revisiones: 6,
        soporteMeses: 3,
        resumen: {
      ...
      },
      {
        ...
        precioEstimado: true,
        entregaDias: 120,
        entrega: { es: "16 a 24 semanas", en: "16 to 24 weeks" },
        revisiones: 8,
        soporteMeses: 6,
        resumen: {
