...
export default function ComparativaPaquetes({
  ...
  return (
    <section aria-labelledby="comparar-heading">
      <Reveal>
        <h2
          id="comparar-heading"
              ...
              <tr className="border-b-2 border-[var(--color-border)]">
                ...
                {servicio.planes.map((p, i) => (
                  <th
                    ...
                    scope="col"
                    className={cn(
                      "px-5 py-4 align-bottom transition-colors duration-[var(--duration-base)]",
                  ...
                  >
                    ...
                    {p.badge && (
                      <span
                        className={cn(
                          "mt-1.5 inline-block rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider",
                          p.destacado
              ...
              <tr className="border-b border-[var(--color-border-subtle)]">
                ...
                {servicio.planes.map((p, i) => (
                  <td
                    key={p.nivel}
                    className={cn(
                      "px-5 py-3 text-center font-medium tabular-nums text-[var(--color-text-primary)]",
                      i === indiceActivo && "bg-[var(--color-brand-soft)]",
                    )}
                  >
                    {p.revisiones}
